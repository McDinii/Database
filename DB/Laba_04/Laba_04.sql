...
insert into  TEACHER    (TEACHER,  TEACHER_NAME, GENDER, PULPIT )
                       values  (Null,   NULl,  NULL,   'ИСиТ');                                                                                           
insert into  TEACHER    (TEACHER,  TEACHER_NAME, GENDER, PULPIT )
                       values  ('АРС',     'Арсентьев Виталий Арсентьевич', 'м', 'ИСиТ');                       
insert into  TEACHER    (TEACHER,  TEACHER_NAME, GENDER, PULPIT )
...
insert into SUBJECT   (SUBJECT,   SUBJECT_NAME,PULPIT )
                       values ('ТОПИ',   'Технология обогащения полезных ископаемых ','ОХ')
insert into SUBJECT   (SUBJECT,   SUBJECT_NAME, PULPIT )
...
from AUDITORIUM as AU inner join AUDITORIUM_TYPE as AUT on AU.AUDITORIUM_TYPE = AUT.AUDITORIUM_TYPE and AUDITORIUM_TYPENAME like '%компьютер%'
...
select AUDITORIUM, AU.AUDITORIUM_TYPE as TYPE, AUDITORIUM_TYPENAME as ANAME,  
AUDITORIUM_CAPACITY as CAPACITY, AUDITORIUM_NAME as NUM 
from AUDITORIUM as AU, AUDITORIUM_TYPE as AUT where AU.AUDITORIUM_TYPE = AUT.AUDITORIUM_TYPE and AUDITORIUM_TYPENAME like '%компьютер%'
...
Select  P.PULPIT_NAME [Кафедра],isnull(T.TEACHER_NAME,'***') [Преподаватель]
from PULPIT as P 
...
Select  P.PULPIT_NAME [Кафедра],T.TEACHER_NAME [Преподаватель]
from TEACHER as T
...
select Заказчики.Фамилия, Заказы.Дата_заказа from Заказчики join Заказы on Заказчики.Заказчик_id = Заказы.Заказчик
